...
After making significant system changes (new commands, AGENTS.md edits, structural changes), update `CHANGELOG.md` before finishing the task.
...
- **Never ask again**: 
  ...
  - Remove this section from AGENTS.md
...
- `/dex-update` - Update Dex automatically (shows what's new, updates if confirmed, also updates AGENTS.md)
